...
<script type="text/javascript">
    ...
    require(
            ...
            function($) {
                ...
                var $generalApplicationSettings = $form.find('#general_application_settings');
                ...
                var $applicationSettingsName = $generalApplicationSettings.find('.application_settings_name');
                var $applicationSettingsFolder = $generalApplicationSettings.find('.application_settings_folder');
                var $applicationSettingsNamespace = $generalApplicationSettings.find('.application_settings_namespace');

                $applicationSettingsName.keyup(function() {
                ...
                $applicationSettingsNamespace.keyup(function() {
                    var namespace = $applicationSettingsNamespace.val();
                    var newName = toSlashName(namespace);
                ...
                function addField($el) {
                    ...
                    $columnInput.keyup(function() {
                        toUnderscoreNameInput($columnInput);
                    });
                    ...
                    function titleToColumn() {
                        if ($useTitleCheckbox.is(':checked')) {
                            $columnInput.val(toUnderscoreName($labelInput.val()));
                        }
                    }
...
/*
                ...
                function toUnderscoreNameInput($input) {
                    var name = $input.val()
                    var newName = toUnderscoreName(name);
                    if (name !== newName) {
                        $input.val(newName);
                    }
                }

                function toUnderscoreName(str) {
                    return removeDiacritics(str.toLowerCase()).replace(/([^A-Z|a-z| |_])/g, '').trim().replace(/( )/g, '_');
                }
